    ...
    <header css={headerStyles.container}>
      <nav css={headerStyles.navigation}>
        ...
        <ul css={headerStyles.wrapper}>
          <li css={headerStyles.list} onClick={onClick}><AiOutlineSearch size={22}/></li>
          <li css={headerStyles.list}><Notification size={22}/></li>
          <li css={headerStyles.list}><RiArticleLine size={22}/></li>
          <li css={headerStyles.list}><TbLogout size={22}/></li>
        </ul>
      </nav>
    </header>
  )
